...
//        assertEquals(Double.valueOf(16),s1.courses.get(c2));
//        assertEquals(Double.valueOf(19.5),s2.courses.get(c2));
//        assertEquals(Double.valueOf(12),s3.courses.get(c2));
...
//        assertEquals(Double.valueOf(12),s3.courses.get(c1));
//    }
//    @Test
//    public void test3(){
//        t1.addCourse(c1);
...
//        assertEquals(Double.valueOf(12),s3.courses.get(c1));
//        assertEquals(Double.valueOf(16),s3.courses.get(c2));
...
//        assertTrue(s2.courses.keySet().contains(c1));
//        t1.removeStudent(c1,s2);
//        assertFalse(c1.students.keySet().contains(s2));
//        assertFalse(s2.courses.keySet().contains(c1));
//
//    }
//}
